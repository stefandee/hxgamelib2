...
class Rect
{
  ...
  public var left(getL, null)            : Float;
  public var right(getR, null)           : Float;
  public var top(getT, null)             : Float;
  public var bottom(getB, null)          : Float;
