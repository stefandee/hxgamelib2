...
class Vector3f
{
	public static inline var ZERO       : Vector3f = new Vector3f(0, 0, 0);
	public static inline var UNIT_X     : Vector3f = new Vector3f(1, 0, 0);
	public static inline var UNIT_Y     : Vector3f = new Vector3f(0, 1, 0);
  public static inline var UNIT_Z     : Vector3f = new Vector3f(0, 0, 1);
  public static inline var UNIT_NEG_Z : Vector3f = new Vector3f(0, 0, -1);
