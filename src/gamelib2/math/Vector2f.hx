...
class Vector2f
{
	public static inline var UNIT_X : Vector2f = new Vector2f(1, 0);
	public static inline var UNIT_Y : Vector2f = new Vector2f(0, 1);
	public static inline var UNIT_NEG_X : Vector2f = new Vector2f(-1, 0);
	public static inline var UNIT_NEG_Y : Vector2f = new Vector2f(0, -1);
