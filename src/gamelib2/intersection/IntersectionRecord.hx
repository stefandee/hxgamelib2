...
{
  private var distances (default, null) : FastList<Float>;
  private var points    (default, null) : FastList<Vector3f>;
   ...
   */
  public function new(?distances : FastList<Float> = null, ?points : FastList<Vector3f> = null) 
  {
    if (distances == null || points == null)
    {
      distances = new FastList<Float>();
