...
class ScrollBar extends Control
{
  ...
  public var maxPosition (default, setMaxPosition) : Int;
  public var step        (default, setStep)        : Int;
  ...
  private function setPosition(pos : Int)
  {
    //if (maxPosition == null)
    //{
  ...
  private function setMaxPosition(pos : Int)
  {
    if (pos < 0)
    {
      pos = 0;
  ...
  private function setStep(v : Int) : Int
  {
    if (v < 0)
    {
      v = 0;
  ...
  private function setSize(size : Int) : Int
  {
