...
{
  public var leaderboard (default, setLeaderboard) : Leaderboard;

  private var rows                                 : Array<LeaderboardRow>;
  private var columnSetup                          : Array<ColumnSetup>;
  private var scrollBar                            : ScrollBar;

  private var topRow (default, setTopRow)          : Int;
  ...
  private function setLeaderboard(v : Leaderboard) : Leaderboard
  {
    leaderboard = v;
  ...
  private function setTopRow(v : Int) : Int
  {
    topRow = v;
