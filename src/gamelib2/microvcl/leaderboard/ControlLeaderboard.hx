...
{  
  ...
  public var leaderboards       : Hash<Leaderboard>;
  ...
  public var showLastSubmission (default, setShowLastSubmission) : Bool;
  ...
  */
  ...
  private function setShowLastSubmission(v : Bool) : Bool
  {
