...
class Helper
{
  ...
  public static function drawGradientWBox(g : Graphics, boxX : Int, boxY : Int, w : Int, h : Int, colors : Array<Int>, alphas : Array<Float>, ?reverse : Bool = false, ?direction : Bool = false)
  {
  ...
  public static function createGradientWBox(boxX : Int, boxY : Int, w : Int, h : Int, colors : Array<Int>, alphas : Array<Float>, ?reverse : Bool = false, ?direction : Bool = false) : Sprite
  {
    var box = new Sprite();
