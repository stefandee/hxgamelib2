...
{ 
  ...
  public var dialogFlags(default, setDialogFlags)      : DialogFlags;
  ...
  private function setMessage(v : String) : String
  {
    message = v;
  ...
  private function setDialogFlags(v : DialogFlags) : DialogFlags
  {
    dialogFlags = v;
